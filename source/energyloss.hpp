...
private:
    ...
    double FdA412(double ph, double dp, double mFactor, double invExpNorm, double ph_over_p, const LinearInterpolator<double> &dndx, std::size_t p_idx_dndx) const noexcept;
    double FdA413(double ph, double dp, double mFactor, double invExpNorm, double ph_over_p, const LinearInterpolator<double> &dndx, std::size_t p_idx_dndx) const noexcept;
    double FdA414(double ph, double dp, double mFactor, double invExpNorm, double ph_over_p, const LinearInterpolator<double> &dndx, std::size_t p_idx_dndx) const noexcept;
    double FdA415(double ph, double dp, double mFactor, double invExpNorm, double ph_over_p, const LinearInterpolator<double> &dndx, std::size_t p_idx_dndx) const noexcept;
