...
int GetInputs(int argc, char const *argv[],                    std::string &snn, std::string &pname,                    double &xb, size_t &LdndxMaxPts, size_t &LCollMaxPts); 				    							  	//function that gets inputs for LTables calculations
